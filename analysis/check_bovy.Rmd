...
I want to know if Bovy's EM algorithm will only create matrices that span the same space as the initial conditions. Turns out this is correct. We just get a scaled estimate of the initial vector.
